          ...
          <?php if( get_theme_mod( 'vw_bakery_toggle_postdate',true) == 1 || get_theme_mod( 'vw_bakery_toggle_author',true) == 1 || get_theme_mod( 'vw_bakery_toggle_comments',true) == 1 || get_theme_mod( 'vw_bakery_toggle_time',true) == 1) { ?>
            <div class="post-info">
              <?php if(get_theme_mod('vw_bakery_toggle_postdate',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('vw_bakery_toggle_postdate_icon','fas fa-calendar-alt')); ?>"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $vw_bakery_archive_year, $vw_bakery_archive_month, $vw_bakery_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
              <?php } ?>

              <?php if(get_theme_mod('vw_bakery_toggle_author',true)==1){ ?>
                <span><?php echo esc_html(get_theme_mod('vw_bakery_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('vw_bakery_toggle_author_icon','far fa-user')); ?>"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span>
              <?php } ?>

              <?php if(get_theme_mod('vw_bakery_toggle_comments',true)==1){ ?>
                <span><?php echo esc_html(get_theme_mod('vw_bakery_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('vw_bakery_toggle_comments_icon','fa fa-comments')); ?>" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'vw-bakery'), __('0 Comments', 'vw-bakery'), __('% Comments', 'vw-bakery') ); ?> </span>
              <?php } ?>

              <?php if(get_theme_mod('vw_bakery_toggle_time',true)==1){ ?>
                <span><?php echo esc_html(get_theme_mod('vw_bakery_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('vw_bakery_toggle_time_icon','far fa-clock')); ?>"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
              <?php } ?>
              <hr>
            </div> 
          <?php } ?>     
