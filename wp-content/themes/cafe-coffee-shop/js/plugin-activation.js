jQuery(document).ready(function($) {
    'use strict';
    var this_obj = cafe_coffee_shop_plugin_activate_plugin;
    ...
    $(document).on('click', '.cafe-coffee-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message cafe-coffee-shop-plugin-install');
                button.addClass('button-primary cafe-coffee-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.cafe-coffee-shop-recommended-plugins .cafe-coffee-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.cafe-coffee-shop-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .cafe-coffee-shop-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .cafe-coffee-shop-recommended-plugins').css('display','none');
    });
